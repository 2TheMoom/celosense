      ...
      <section className="land-hero">
        <div className="land-hero-inner">
          ...
          <div className="land-hero-ctas">
            ...
            <a href="https://celoscan.io/address/0x8a30F753942458897619A83D6467B0FF62DE7Abd#code" target="_blank" rel="noopener noreferrer" className="land-btn-secondary">View Contract ↗</a>
          </div>
